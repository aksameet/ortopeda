        ...
        content: () => {
            return (
                <div className="obszary-content-description">
                    <h3>Taping</h3>
                    <p>
                        Plastrowanie (inaczej taping, nalepianie plastra) - metoda leczenia poprzez aplikację na ciele, w ściśle określony sposób, nierozciągliwego lub elastycznego plastra. Nalepiony plaster jest źródłem bodźców wyłącznie mechanicznych (nie jest nasączony żadnym lekiem) i w zależności od rodzaju, sposobu i miejsca aplikacji, ma różnorakie oddziaływanie. Jedną z metod tapingu jest plastrowanie dynamiczne. Taping znajduje zastosowanie w fizjoterapii przeciwbólowej, ortopedycznej, sportowej, neurologicznej, pediatrycznej, pooperacyjnej, ginekologicznej, onkologicznej.
                    </p>
                </div>
            )
        }
